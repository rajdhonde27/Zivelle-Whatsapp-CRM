    ...
    <div className={cn("flex min-w-0 flex-1 flex-col", DOODLE_BG_CLASSES)}>
      ...
      <div className="flex items-center justify-between gap-2 border-b border-border bg-card px-3 py-3 sm:px-4">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          {/* Contact avatar and name — clickable on mobile to open contact drawer */}
          <button
            type="button"
            onClick={() => setMobileContactOpen(true)}
            className="flex min-w-0 items-center gap-2 text-left sm:gap-3 lg:cursor-default"
            title={t("showContact")}
          >
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Mobile contact info drawer button */}
          <button
            type="button"
            onClick={() => setMobileContactOpen(true)}
      ...
      {/* Mobile Contact Profile & Tag/Deal Drawer */}
