...
export type ContentType =
  ...
  | 'interactive'
  /** Customer submitted a cart / order from WhatsApp Product Catalog. */
  | 'order';
...
export interface Message {
  ...
  /**
   * Structured cart / order payload when content_type === 'order'.
   * Migration 043.
   */
  order_details?: OrderPayload | null;
}
...
// ============================================================
// Commerce, Product Catalog & Orders (migration 043)
// ============================================================

export type ProductSource = 'meta' | 'shopify' | 'woocommerce' | 'manual';
